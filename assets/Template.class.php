...
Class Template
{
    ...
    public function __construct($array, $view)
    {
        ...
        $this->view = $view;
        $this->final = '';
        $this->html = file_get_contents("ass/html/" . $this->view . '.html');
        $this->addTemplate();
        $this->merge();
        $this->addIf();
        $this->addIfn();
    ...
    {
        $i = 0;
        $this->final = preg_replace_callback('/{\%IF /s', '\ass\Template::incrementIf', $this->final);
    ...
    {
        $i = 0;
        $this->final = preg_replace_callback('/{\%IFN /s', '\ass\Template::incrementIfn', $this->final);
    ...
    {
        $this->final = preg_replace_callback('/{\*FOR /s', '\ass\Template::incrementFor', $this->final);
    ...
    private function addTemplate()
    {
        ...
        foreach ($matches[1] as $v)
            $this->final .= file_get_contents("ass/html/" . $v . '.html');
    }
